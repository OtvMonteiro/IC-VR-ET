...
public class StoreViewpoints : MonoBehaviour
{
    ...
    //Usando o BinaryManagerHeatmap para guardar os dados
    private ItemEntry user;
    private List<HeatmapHybrid.InfoperSecondHeatmap> infoHeatmap = new List<HeatmapHybrid.InfoperSecondHeatmap>();
    ...
    //Salva os dados com o BinaryManagerHeatmap ao sair da aplicacao / Retornar valores originais dos prefabs
    void OnApplicationQuit()
    {
        if (!ModoPlayer) { //Somente no modo normal, o modo replay nao deve armazenar novamente os dados
            BinaryManagerHeatmapSave();
    ...
    public void storePoints(Vector3 pontoAnterior, Vector3 pontoAtual)
    {
        ...
        else//se existir ponto ele sera armazenado
        {
            ...
            //Salvar://Lista de InfoperSecondHeatmap para o ItemEntry do BinaryManagerHeatmap //Atualmente com as infos de EyeT zeradas
    ...
    private void BinaryManagerHeatmapSave()
    {
        ...
        BinaryManagerHeatmap.SaveInfo(user, endereco);
    }
    ...
    {
        infoHeatmap = BinaryManagerHeatmap.LoadInfo(CaminhoDoArquivoDeReplay);
